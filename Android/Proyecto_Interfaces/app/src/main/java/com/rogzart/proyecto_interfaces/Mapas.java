...
public class Mapas extends FragmentActivity implements
    ...
    public Mapas() throws InterruptedException, ApiException, IOException {
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mapa.moveCamera(CameraUpdateFactory.newLatLngZoom(Plaza_Principal, 15));
       // mapa.addPolyline(new PolylineOptions().add(atemajac,san_emiliano).width(5).color(Color.RED));
        ...
        DirectionsResult result = DirectionsApi.newRequest(getGeoContext())
                .mode(TravelMode.DRIVING).origin(str_org)
                .destination(str_dest).departureTime(now).awaitIgnoreError();
        //addMarkersToMap(result, mapa);
       // addPolyline(result, mapa);
    ...
    public void moveCamera(View view) {
        mapa.moveCamera(CameraUpdateFactory.newLatLng(Plaza_Principal));
    }
